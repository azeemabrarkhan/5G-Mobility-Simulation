...
xAxis = categorical({'Images Slow', 'Images Fast', '15fps, 5sec Video Slow', '15fps, 5sec Video Fast', '15fps, 10sec Video Slow', '15fps, 10sec Video Fast', '30fps, 5sec Video Slow', '30fps, 5sec Video Fast', '30fps, 10sec Video Slow', '30fps, 10sec Video Fast'});
xAxis = reordercats(xAxis,{'Images Slow', 'Images Fast', '15fps, 5sec Video Slow', '15fps, 5sec Video Fast', '15fps, 10sec Video Slow', '15fps, 10sec Video Fast', '30fps, 5sec Video Slow', '30fps, 5sec Video Fast', '30fps, 10sec Video Slow', '30fps, 10sec Video Fast'});
