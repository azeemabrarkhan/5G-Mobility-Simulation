...
int MigrationTimerDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 'o' && strcmp(fieldName, "oldAppId") == 0) return base+0;
    if (fieldName[0] == 'n' && strcmp(fieldName, "newAppId") == 0) return base+1;
...
int MigrationTimerDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    MigrationTimer *pp = (MigrationTimer *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *MigrationTimerDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string MigrationTimerDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool MigrationTimerDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    MigrationTimer *pp = (MigrationTimer *)object; (void)pp;
    switch (field) {
        case FIELD_oldAppId: pp->setOldAppId(string2ulong(value)); return true;
        case FIELD_newAppId: pp->setNewAppId(string2ulong(value)); return true;
...
void *MigrationTimerDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
