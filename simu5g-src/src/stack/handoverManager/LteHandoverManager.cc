...
{
    sentHandoverReqs = 0;
    successfulHandoverReqs = 0;
    sentHandoverReqsSingal = registerSignal("sentHandoverReqsSingal");
    successfulHandoverReqsSingal = registerSignal("successfulHandoverReqsSingal");
...
void LteHandoverManager::sendHandoverCommand(MacNodeId ueId, MacNodeId enb, bool startHo)
{
    ...
    if(startHo) {
        sentHandoverReqs = sentHandoverReqs + 1;
        emit(sentHandoverReqsSingal, sentHandoverReqs);
    }
}
...
void LteHandoverManager::receiveHandoverCommand(MacNodeId ueId, MacNodeId enb, bool startHo)
{
    ...
    if (startHo)
        ...
        successfulHandoverReqs = successfulHandoverReqs + 1;
        emit(successfulHandoverReqsSingal, successfulHandoverReqs);
    }
}
...
void LteHandoverManager::finish()  {
        recordScalar("sentHandoverReqs", sentHandoverReqs);
        recordScalar("successfulHandoverReqs", successfulHandoverReqs);
}
