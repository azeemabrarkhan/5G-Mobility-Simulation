...
void NRPhyUe::initialize(int stage)
{
    ...
    successfulHandoversSingal = registerSignal("successfulHandoversSingal");
    triggeredHandovers = 0;
    triggeredHandoversSingal = registerSignal("triggeredHandoversSingal");
}
...
void NRPhyUe::triggerHandover()
{
    ...
    triggeredHandovers = triggeredHandovers + 1;
    emit(triggeredHandoversSingal, triggeredHandovers);
...
void NRPhyUe::doHandover()
{
    ...
    emit(successfulHandoversSingal, successfulHandovers);
...
void NRPhyUe::finish()
{
    ...
    recordScalar("triggeredHandovers", triggeredHandovers);
}
